...
\section{Implementation and architecture}
	...
	\subsection{Exponentiator}
		...
		\end{align}
		Here $ z = \omega_z/n $, $q = \omega_q/n $, $ \Phi = \sqrt{\omega_x^2 + \omega_y^2}/n $, $ \phi = \mathrm{atan}2(\omega_y, \omega_x) $, $ D_{z,q} = zJ_z + qQ $ and $ J_\phi = \cos(\phi) J_x + \sin(\phi) J_y $.
		...
		% though this was not rigorously tested as our lab does not deal with physical systems that would require this functionality to work.
