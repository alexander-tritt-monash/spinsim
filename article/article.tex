...
\subsection{Motivation}
	...
	We use these properties (see \emph{\nameref{sec:parallelization}}) to write a parallel, GPU based solver that runs faster than industry standard non-parallel algorithms by three orders of magnitude.
	% Mention GPU in fewer words
	...
	\subsection{Recent literature} % Recent relevant software? Recent software with similar functionality
