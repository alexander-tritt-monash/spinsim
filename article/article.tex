...
\section{Implementation and architecture}
	...
	\subsection{Exponentiator}
		...
		For spin-half, the default exponentiator is in an analytic form in \(\omega_x\).% ... yz, which follows directly from eqref
		...
		In fact, commutation relations between the Lie basis operators and Lie half step splitting allow us to write \(T = \exp(-iD_{z,q}/2n)\exp(-i\Phi J_\phi/n)\exp(-iD_{z,q}/2n)\) % Splitting methods
