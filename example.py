...
# simulator = spinsim.Simulator(get_source, spinsim.SpinQuantumNumber.HALF)

# state_init = np.asarray([1, 0], np.cdouble)

# state, time = simulator.get_state(0, 0e-3, 100e-3, 100e-9, 500e-9, state_init)

# spin = simulator.get_spin(state)
